...
/* Command-line: /Work/Development/bin/gperf --output-file=src_colors.c colors.gperf  */
...
#endif
static unsigned int
svg_color_hash (register const char *str, register unsigned int len)
{
...
svg_color_lookup (register const char *str, register unsigned int len)
{
  static const struct svg_named_color wordlist[] =
    {
...
#line 172 "colors.gperf"
      {"yellow",		RGB(255, 255,   0)},
#line 173 "colors.gperf"
      {"yellowgreen",	RGB(154, 205,  50)},
#line 104 "colors.gperf"
      {"lightskyblue",	RGB(135, 206, 250)},
#line 68 "colors.gperf"
      {"deepskyblue",	RGB(  0, 191, 255)},
#line 171 "colors.gperf"
      {"whitesmoke",	RGB(245, 245, 245)}
    };

  if (len <= MAX_WORD_LENGTH && len >= MIN_WORD_LENGTH)
    {
      register int key = svg_color_hash (str, len);

      if (key <= MAX_HASH_VALUE && key >= MIN_HASH_VALUE)
        {
          register const struct svg_named_color *resword;
