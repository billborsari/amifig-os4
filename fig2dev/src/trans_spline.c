...
static void spline_segment_computing(float step, int k, F_point *p0, F_point *p1, F_point *p2, F_point *p3, double s1, double s2);
static float step_computing(int k, F_point *p0, F_point *p1, F_point *p2, F_point *p3, double s1, double s2, float precision);
static INLINE void point_adding(double *A_blend, F_point *p0, F_point *p1, F_point *p2, F_point *p3);
static INLINE void point_computing(double *A_blend, F_point *p0, F_point *p1, F_point *p2, F_point *p3, int *x, int *y);
static INLINE void negative_s1_influence(double t, double s1, double *A0, double *A2);
static INLINE void negative_s2_influence(double t, double s2, double *A1, double *A3);
static INLINE void positive_s1_influence(int k, double t, double s1, double *A0, double *A2);
static INLINE void positive_s2_influence(int k, double t, double s2, double *A1, double *A3);
static INLINE double f_blend();
static INLINE double g_blend();
static INLINE double h_blend();
static void free_point_array(zXPoint *pts);
...
static	BOOL init_point_array(int init_size, int step_size)
{
    npoints = 0;
...
static		BOOL add_point(int x, int y)
{
...
zXPoint * compute_open_spline(F_spline *spline, float precision)
{
  int       k;
  float     step;
  F_point   *p0, *p1, *p2, *p3;
...
zXPoint *compute_closed_spline(F_spline *spline, float precision)
{
  int k, i;
  float     step;
