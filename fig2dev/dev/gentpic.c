...
void gentpic_ctl_spline(F_spline *s);
void gentpic_itp_spline(F_spline *s);
void gentpic_open_spline(F_spline *s);
void gentpic_closed_spline(F_spline *s);

static void bezier_spline(double a0, double b0, double a1, double b1, double a2, double b2, double a3, double b3);
static void newline(void);
// aks

void gentpic_option(char opt, char *optarg)
{
	switch (opt) {
...
static double convy(double a)
{
	return((double) TOP-a);
}

void gentpic_start(F_compound *objects)
{
	ppi = ppi/mag;
...
// aks static void set_style(int s, float v)
{
...
static void set_baseline(int b)
{
...
static void set_texture(int cur_texture)
{
	/*
 ...
 */
static void set_fill(int cur_fill)
{
...
void gentpic_spline(F_spline *s)
{
	if (int_spline(s))
...
void gentpic_ellipse(F_ellipse	*e)
{
