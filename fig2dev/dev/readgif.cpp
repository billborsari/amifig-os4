...
static Boolean ReadColorMap(FILE *fd, unsigned int number, unsigned char cmap[3][MAXCOLORMAPSIZE]);
...
#ifdef WIN32
	// this is necessary, because the TMPDIR from fig2dev.c is not visible within the extern "C" block
	// I don't know why.
	char TMPDIR[1024] = "";
