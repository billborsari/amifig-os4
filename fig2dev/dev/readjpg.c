...
JPEGtoPS(char *jpegfile, FILE *PSfile) {
  ...
  fprintf(PSfile, "%%%%Creator: jpeg2ps %s by Thomas Merz %s\n", VERSION, winfigVersion);
...
// aks: "Page" should not be used for included files
...
// aks: "EOF" should not be used for included files
//  fprintf(PSfile, "\n%%%%EOF\n");
