    ...
    F_line *l;
{
	...
	if (read_png(picf, filtype, l->pic, &pllx, &plly, tfp) == 0) {
...
/*~~~~~|><|~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
void genemf_option(char opt, char *optarg)
{
...
struct driver dev_emf = {
	genemf_option,
	genemf_start,
	gendev_null2,		/* TODO - Create genemf_grid for 3.2.4 */
	genemf_arc,
	genemf_ellipse,
	genemf_line,
	genemf_spline,
