...
static void chaikin_curve(double a1, double b1, double a2, double b2, double a3, double b3);
static void quadratic_spline(double a1, double b1, double a2, double b2, double a3, double b3, double a4, double b4);
static void bezier_spline(double a0, double b0, double a1, double b1, double a2, double b2, double a3, double b3);
void rtop(double x, double y, double *r, double *th);
void setfigfont( F_text *text );
void drawarc(FPoint *ctr, double r, double th1, double angle);
static void arc_arrow(FPoint *pt1, FPoint *pt2, int direction, F_arrow *arrow, FPoint *pt3);
static void draw_arrow_head(F_point *pt1, F_point *pt2, double arrowht, double arrowwid, int type, int style, double thickness);
void fdraw_arrow_head(FPoint *pt1, FPoint *pt2, double arrowht, double arrowwid, int type, int style, double thickness);
char* FillCommands(int style, int color);
// aks
...
void genepic_option(char opt, char *optarg)
{
  	int loop, i;
...
static void fconvertCS(FPoint *fpt)
{
...
static void convertCS(F_point *pt)
{
    pt->y = TopCoord - pt->y;
    pt->x -= LLX;
    pt->y -= LLY;
...
void genepic_start(F_compound *objects)
{
    int temp;
    F_point pt1, pt2;
...
static void set_pattern(int type, int color)
{
...
static void genepic_spline(F_spline *s)
{
    /* print any comments prefixed with "%" */
...
void genepic_ellipse(F_ellipse *ell)
{
    F_point pt;
