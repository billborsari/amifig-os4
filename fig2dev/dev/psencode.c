 ...
 *                                                                     *
 ***********************************************************************/
long PSencode(int Width, int Height, int Transparent, int Ncol, byte R[], byte G[], byte B[], unsigned char *data)
{
...
void PSrgbimage(FILE *file, int width, int height, unsigned char *data)
{
    int		 c, h, w, left;
    unsigned char *p;
